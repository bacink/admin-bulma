      ...
      <div class="login">
        ...
        <form @submit.prevent="addUser">
          ...
          <a
            ...
            href="https://sim-asn.bkpsdm.karawangkab.go.id/oauth/authorize?client_id=949304c6-ecd1-460a-a8fb-c5c4abf9e34e&redirect_uri=https://api.jafung.bkpsdm.karawangkab.go.id/api/callback/sim-asn&response_type=code&scope=profile+pegawai&state=login"
          >
