          ...
          <b-card title="Draft Surat Keputusan">
            ...
            <template v-if="!isLoading">
              <table width="100%" class="table">
                ...
                <tr
                  v-for="(item, index) in formData.isi.memperhatikan"
                  :key="index + 'b'"
                  has-background-info
                >
                  <template v-if="index === 0">
                ...
                <tr>
                  ...
                  <td>
                    <b-input
                      v-model="formData.isi.pegawai.pangkat_gol"
                    ></b-input>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <b-input
                      v-model="formData.isi.pegawai.pendidikan"
                    ></b-input>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <b-input
                      v-model="formData.isi.pegawai.unit_kerja"
                    ></b-input>
                  </td>
                </tr>
                <tr>
